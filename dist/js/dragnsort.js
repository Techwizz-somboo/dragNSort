/**
* dragnsort version 1.0.0. Made by Paul Black. MIT license.
* Visit https://dragnsort.dev/ for more information.
* Source code: https://github.com/Techwizz-somboo/dragnsort/
**/
"use strict";
...
DragNSort.prototype.onDrop = function (_this, event) {
  ...
  var customEvent = new CustomEvent('handle-drag', {
    detail: {
      from: sourceNode,
      to: this
    }
...
DragNSort.prototype.init = function () {
  var identifier = Math.random().toString(36).slice(2, 10);
  this.$container.classList.add("drag-initialized-".concat(identifier));
  this.$items.forEach(function ($item) {
...
function initializeDragNSort() {
  var listGroups = document.querySelectorAll('.drag-list:not([class*="drag-initialized"])');
...
function DragNSort_adjustItemHeights() {
  var listGroups = document.querySelectorAll('.drag-list');
  listGroups.forEach(function (group) {
